...
// ---------------------------------------------------------------------------
// No built-in LLM. The bridge relays messages between SoloBox and the user's
// own agent via HTTP API (GET /event, POST /send). The agent container
// handles all reasoning and response generation.
// ---------------------------------------------------------------------------
...
function startLocalAPI() {
  ...
  server.listen(CONFIG.localPort, "127.0.0.1", () => {
    ...
    log("info", "  No built-in LLM — replies come from user's agent via POST /send");
  });
